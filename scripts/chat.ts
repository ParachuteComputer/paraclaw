/**
 * nc — chat with your Paraclaw agent from the terminal.
 *
 * Usage:
 ...
 *
 * Preconditions: Paraclaw host service running, an agent group wired to
...
function main(): void {
  ...
  socket.on('error', (err) => {
    ...
    if (e.code === 'ENOENT' || e.code === 'ECONNREFUSED') {
      console.error(`Paraclaw daemon not reachable at ${socketPath()}.`);
