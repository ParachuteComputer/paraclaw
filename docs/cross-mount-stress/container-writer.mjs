// Container-side stress writer — uses bun:sqlite, what the agent-runner runs.
// Mirror of host-writer.mjs for the bun runtime. Run inside a container that
// bind-mounts the same session.db the host writer is hitting.
