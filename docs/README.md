# Paraclaw Documentation

Reference for engineers working on or integrating with paraclaw. Read [`architecture.md`](architecture.md) first — it covers the primitives, runtime model, schema, and trust zones in one place.
...
| [parachute-integration.md](parachute-integration.md) | How paraclaw plugs into the Parachute hub: install, OAuth, vault attachments |
...
| [db-central.md](db-central.md) | Central DB schema reference (`~/.parachute/claw/paraclaw.db`) |
